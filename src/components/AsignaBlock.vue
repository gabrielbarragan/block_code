...
--dfBackgroundColor: #ffffff;
  ...
  --dfNodeBackgroundColor: rgb(230, 54, 54);
  ...
  --dfNodeHoverBackgroundColor: rgb(240, 3, 3);
  ...
  --dfNodeSelectedBackgroundColor: rgb(187, 27, 27);
...
.drawflow .drawflow-node .blockcode-variable{
...
.drawflow .drawflow-node:hover .blockcode-variable{
...
.drawflow .drawflow-node.selected .blockcode-variable{
